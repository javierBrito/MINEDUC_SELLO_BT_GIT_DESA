...
import ec.gob.educacion.sellobt.dto.LoginDTO;
import ec.gob.educacion.sellobt.dto.MenuDTO;
import ec.gob.educacion.sellobt.dto.ResponseLoginDTO;
...
public class LoginRest {
	...
	private static String usuarioJson(String identificacion, String clave) {
		return "{" + "\"resu\":\"" + identificacion + "\"," + "\"ssap\":\"" + clave + "\", \"prefijoApp\": \"SBT\"}";
	}
}
