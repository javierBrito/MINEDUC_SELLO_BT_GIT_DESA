...
import ec.gob.educacion.model.sellobt.PenRespuesta;
...
public interface DerespuestasRepository extends JpaRepository<PenRespuesta, Integer>{
	 ...
	 * @author Belen changoluisa
	 */
	@Query(value = "select new ec.gob.educacion.sellobt.dto.DerespuestasDTO ( p.preCodigo,  r.resCodigo,  r.resOrden,  r.resRespuesta, r.resEstado ) from PenPregunta p, PenRespuesta r where p.preCodigo = r.penPregunta and p.preCodigo =:preCodigo and  r.resEstado =:resEstado ")
